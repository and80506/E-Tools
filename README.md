...
- 界面简洁、操作顺滑的列表管理
- **交易复盘**：快捷录入历史买卖操作，独立抽屉纵览真实交易盈亏与逻辑
- **自由现金流 (FCF) 计算**：一键计算 TTM 自由现金流及收益率，支持跨期数据相加
...
- 全屏沉浸模式，排除干扰，专注总结
- **富文本支持**：集成现代化 Markdown 编辑器，支持丰富的排版格式
...
### 📈 公司估值模型
- **公司估值 (段永平法)**：通过当前市值和真现金流倒推市场隐含的永续增长预期
- **三阶段 DCF 模型**：支持高速增长、过渡期、永续期的自由现金流贴现估值，精细化评估安全边际
